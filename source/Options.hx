...
class ScrollSpeedOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Scroll Speed: < " + Maths.truncateFloat(FlxG.save.data.scrollSpeed, 1) + " >";
	}
...
class OffsetThing extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Note offset: < " + Maths.truncateFloat(FlxG.save.data.offset, 0) + " >";
	}
...
{
	//ill replace this with my own code later when noteskins are implemented
}
...
class LaneUnderlayOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Lane Transparceny: < " + Maths.truncateFloat(FlxG.save.data.laneTransparency, 1) + " >";
	}
