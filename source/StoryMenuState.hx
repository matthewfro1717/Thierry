...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width + 10, grpWeekText.members[1].y - 50);
	...
	function imageBgCheck()
	{
		...
		{
			case 1:
				path = Paths.image('storymenu/thierry', 'shared');
				position = new FlxPoint(600, 55);
			case 2:
				path = Paths.image('storymenu/thierry2', 'shared');
				position = new FlxPoint(600, 55);
			case 3:
				path = Paths.image('storymenu/radit', 'shared');
				position = new FlxPoint(600, 55);
			default:
				path = Paths.image('storymenu/blank', 'shared');
