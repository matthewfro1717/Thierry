...
class CoolMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('selectBG'));
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('selectBG'));
		...
		var tex = Paths.getSparrowAtlas('Thierry_cool_menu_assets');
