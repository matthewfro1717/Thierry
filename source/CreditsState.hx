...
class CreditsState extends MusicBeatState
{
	...
	private var grpOptions:FlxTypedGroup<PsychEngine.PsychAlphabet>;
	...
	override function create()
	{
		...
		for (i in 0...creditsStuff.length)
		{
			...
			var optionText:PsychAlphabet = new PsychAlphabet(0, 70 * i, creditsStuff[i][0], !isSelectable, false);
			optionText.isMenuItem = true;
			optionText.screenCenter(X);
			optionText.yAdd -= 70;
			if(isSelectable) {
				optionText.x -= 70;
                optionText.color = 0xffffff;
			}
